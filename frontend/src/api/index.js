...
export function getBlogsByUid(params) {
    return request({
        url: process.env.WEB_API + '/getBlogsByUid',
        method: 'get',
        params
    })
}

export function getAvatarsByUserID(params) {
    return request({
        url: process.env.WEB_API + '/index/getAvatarsByUserID',
        method: 'get',
        params
    })
}
